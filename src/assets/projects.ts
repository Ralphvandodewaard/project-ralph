...
const projects: Project[] = [
  ...
  },
  {
    ...
    tags: ['Vue 3 Options API', 'Typescript'],
    links: [
  ...
  {
    label: 'League-quotes',
    description: 'League-quotes (2022) is a browser game where you have to guess by which League of Legends champion a certain quote is said and try to get the highest possible score.',
    tags: ['Vue 3 Options API', 'Typescript', 'Tailwind CSS'],
    links: [
  ...
  },
  {
    ...
    tags: ['Angular 14', 'Typescript', 'Tailwind CSS', 'Riot Games API', 'PHP', 'MySQL'],
    links: [
  ...
  },
  {
    ...
    tags: ['Angular 13', 'Typescript', 'Tailwind CSS', 'Pokemon TCG API'],
    links: [
